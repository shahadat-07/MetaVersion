        ...
        {({ open }) => (
          <>
            ...
            >
              ...
              <Popover.Panel className="absolute right-0 z-10 w-[400px] h-[500px]">
                <div className="overflow-hidden rounded-2xl shadow-lg ring-1 ring-black ring-opacity-5">
                  <div className="relative bg-[#553CDF] rounded-md">
                    ...
                    <p className="mb-4 text-center font-narrow font-semibold">First time here ? Please register.</p>
                      ...
                      <div className="text-center">
                        <Button className="bg-[#553CDF] shadow-xl"> Register </Button>
                      </div>
                    </form>
                    {/* {solutions.map((item) => (
                      <a
