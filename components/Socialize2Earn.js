                ...
                <PageLayout className="flex flex-col lg:flex-row items-center py-2 sm:py-0 ">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-[#FBFBFB] text-center lg:text-start  text-sm sm:text-base md:text-lg 3xl:text-4xl 3xl:leading-[55px] font-narrow mb-4 lg:mb-6 3xl:mb-16">
                            Each person on our planet dreams of something.
                            MyVerse breaks patterns and makes dreams come true.
                            Complete decentralization and freedom of speech, a
                            multifunctional marketplace and a virtual world for
                            interaction. Chat with friends and get real income,
                            look for investments and promote your projects. Use
                            unlimited functionality to make your dreams come
                            true.
                        </p>
